...
public class Planning2View extends MkpkDockLayout {

	private static Logger LOGGER = Logger.getLogger(Planning2View.class.getName());
	...
	private PlanningRow paintTable() {
		rows = new LinkedList<Planning2View.PlanningRow>();
		tab.removeAllRows();
		paintHeader();
		Date date = null;
		double minutes = 0;
